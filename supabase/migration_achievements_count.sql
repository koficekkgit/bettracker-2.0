-- Přidej achievements_count do profiles
ALTER TABLE profiles
  ADD COLUMN IF NOT EXISTS achievements_count integer NOT NULL DEFAULT 0;

-- Updatuj leaderboard_30d view aby zahrnoval achievements_count
-- (Nejdřív drop, pak create — view nelze ALTER)
